(function($) {
  ...
  $(function() {
    ...
    if ($("#serviceSaleProgress").length) {
      ...
      let linearGradient = '<defs><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse"><stop offset="20%" stop-color="#d1ebb5"/><stop offset="50%" stop-color="#8bc34a"/></linearGradient></defs>';
