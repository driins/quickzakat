...
include('koneksi.php'); ?>
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-3 text-gray-800">Insert Data Muzakki</h1>
                    <form method="POST" action="tabelmuzakki.php">
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Muzakki</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputText3" name="nama_muzakki">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputPassword3" class="col-sm-3 col-form-label">Jumlah Tanggungan</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputText3" name="jumlah_tanggungan">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputSelect" class="col-sm-3 col-form-label">Keterangan</label>
                            <div class="col-sm-8">
